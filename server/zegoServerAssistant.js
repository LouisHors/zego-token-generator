...
// Store the last plainText for each token generation
let lastPlainText = '';

/**
 * Get the plainText from the last token generation
 * @returns {string} The plainText used in the last token generation
 */
...
function generateToken04(appId, userId, secret, effectiveTimeInSeconds, payload) {
    ...
    // Store the plainText for later retrieval
    lastPlainText = plaintText;
